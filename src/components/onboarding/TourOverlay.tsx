    ...
    <div className="fixed inset-0 z-[60] pointer-events-none flex flex-col justify-end pb-24 md:pb-12 px-4 items-center bg-black/20 backdrop-blur-[2px]">
      ...
      {step === 1 && (
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
          ...
          <p className="text-white font-bold text-lg mt-4 drop-shadow-md text-center">
            Pyyhkäise tai raahaa
            <br />
            pyörittääksesi
          </p>
        </div>
      ...
      <div className="pointer-events-auto bg-white/90 backdrop-blur-xl border border-white/50 p-6 rounded-3xl shadow-2xl w-full max-w-sm transition-all duration-500 animate-in slide-in-from-bottom-10 fade-in">
        ...
        {step === 1 && (
          <div className="text-center space-y-4">
            ...
            <button
              onClick={onNext}
              className="w-full py-3 bg-[#002f6c] text-white rounded-xl font-bold shadow-lg hover:bg-blue-900 transition-colors flex items-center justify-center gap-2"
            >
        ...
        {step === 3 && (
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Napauta 3D-mallista omaa asuntoasi jatkaaksesi.
              </p>
            </div>
          </div>
        )}
        ...
        {step === 4 && (
          <div className="space-y-4 text-center">
            ...
            <div className="pt-2 space-y-2">
              <button
                onClick={onComplete}
                className="w-full py-3 bg-emerald-600 text-white rounded-xl font-bold shadow-lg hover:bg-emerald-700 transition-colors flex items-center justify-center gap-2"
              >
