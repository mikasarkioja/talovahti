          ...
          <div className="space-y-1 p-4 pt-0">
            {items.length === 0 && (
              <p className="text-slate-500 text-sm">
                Hiljaista. Ei uusia ilmoituksia.
              </p>
            )}
            {items.map((item) => (
              <div
                key={item.id}
                className="flex gap-3 items-start p-3 rounded-lg hover:bg-slate-800/50 transition-colors border border-transparent hover:border-slate-800"
              >
