    ...
    <div className="container mx-auto max-w-3xl py-12 px-4 space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-500">
          Ota käyttöön Talovahti-palvelu virallisilla MML-tiedoilla.
        </p>
      </div>
      ...
      {step === 1 && (
        <Card className="border-brand-navy/10 text-center py-8">
          ...
          <CardContent>
            ...
            >
              <img
                src="https://suomi.fi/assets/images/suomi-fi-logo.svg"
                alt=""
      ...
      {step === 3 && mmlData && (
        <Card className="border-brand-navy/10">
          <CardHeader>
            ...
            <CardDescription>
              Tarkista tiedot ennen aktivointia. Nämä tiedot haettiin
            ...
            <div className="grid grid-cols-2 gap-4 text-sm bg-surface-lichen p-4 rounded-lg">
              <div>
                ...
                <span className="font-medium">
                  {mmlData.basicInfo.address}, {mmlData.basicInfo.city}
                </span>
              </div>
              <div>
                <span className="text-gray-500 block">Valmistumisvuosi</span>
                <span className="font-medium">
                  {mmlData.basicInfo.constructionYear}
                </span>
              </div>
            </div>
            ...
            <div className="max-h-60 overflow-y-auto border rounded-md">
              <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y">
                  {Array.isArray(mmlData.apartments) &&
                    mmlData.apartments.slice(0, 10).map(
                      (
                        apt,
                        i, // Show first 10
                      ) => (
                        <tr key={i}>
                          ...
                          <td className="p-3">
                            {apt.sharesStart}-{apt.sharesEnd}
                          </td>
                          <td className="p-3">
                            {mmlData.shareholders.find(
                              (s) => s.apartmentNumber === apt.apartmentNumber,
