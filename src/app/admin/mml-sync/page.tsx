...
export default function MMLSyncPage() {
  ...
  if (!isBoard) {
    return <div className="p-20 text-center">Pääsy evätty.</div>;
  }
  ...
  const mappedRenovations = renovations
    .filter((r) => r.status === "COMPLETED")
    .map((r) => ({
      ...r,
      mmlCode: r.component.includes("Katto")
        ? "112 VESIKATTO"
        : r.component.includes("Putki")
          ? "211 KÄYTTÖVESI"
          : "999 MUU",
    }));
    ...
    <div className="p-8 max-w-5xl mx-auto space-y-8">
      <header>
        ...
        <p className="text-slate-500 mt-1">
          Hallinnoi lakisääteisiä ilmoituksia Maanmittauslaitoksen
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">
                      {log.timestamp.toLocaleDateString()} klo{" "}
