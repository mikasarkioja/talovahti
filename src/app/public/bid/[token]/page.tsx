      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <Card className="max-w-md w-full border-red-100 bg-red-50/20">
          <CardContent className="pt-12 pb-12 flex flex-col items-center text-center space-y-4">
            ...
            <Link
              href="/"
              className="text-blue-600 hover:underline flex items-center gap-1 text-sm font-medium pt-2"
            >
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <Badge className="bg-emerald-500 text-white border-none px-3 py-0.5 font-bold">
                PROJEKTI
              </Badge>
          ...
          <div className="text-right">
            <p className="text-blue-200 text-sm uppercase font-bold tracking-widest mb-1">
              Tervetuloa
            </p>
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-500 text-sm mb-4 bg-blue-50 border border-blue-100 p-3 rounded-lg flex items-start gap-3">
              ...
              <span>
                Alla oleva 3D-malli näyttää huollon kohteena olevan rakennusosan
                tai huoneiston sijainnin digitaalisessa kaksosessa.
              </span>
            </p>
            <div className="rounded-2xl border-2 border-slate-200 overflow-hidden shadow-inner bg-slate-100 h-[500px]">
              ...
              <BuildingModel
                highlightId={
                  project.observation?.location
                    ? JSON.parse(project.observation.location).aptId
                    : undefined
                }
              />
            </div>
          ...
          <div className="sticky top-8">
            ...
            <div className="mt-8 p-6 bg-slate-100 rounded-xl border border-slate-200 border-dashed">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Mikäli sinulla on kysyttävää projektin laajuudesta tai tarvitset
                lisätietoja, ota yhteyttä taloyhtiön hallitukseen.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="max-w-6xl mx-auto py-12 px-4 border-t border-slate-200 mt-12 text-center text-slate-400 text-sm">
        <p>
          &copy; {new Date().getFullYear()} Talovahti | Moderni
          Kiinteistönhallinta
        </p>
      </footer>
    </div>
