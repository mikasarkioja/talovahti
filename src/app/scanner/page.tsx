...
export default function ScannerPage() {
  ...
  const [orientation, setOrientation] = useState<[number, number, number]>([
    0, 0, 0,
  ]);
      ...
      <div className="absolute inset-0 z-10 pointer-events-none flex flex-col justify-between p-6">
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex flex-col gap-2">
            <Badge
              variant="outline"
              className="bg-slate-900/80 text-cyan-400 border-cyan-500/50 backdrop-blur-md"
            >
            ...
            {leaks.length > 0 && (
              <Badge
                variant="outline"
                className="bg-slate-900/80 text-red-400 border-red-500/50 backdrop-blur-md animate-pulse"
              >
