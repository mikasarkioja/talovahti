...
import { Hammer, ArrowRight, Check } from 'lucide-react'
...
export default function RenovationPage() {
  ...
  const categories = ['Keittiöremontti', 'Kylpyhuoneremontti', 'Pintaremontti (lattiat/seinät)', 'Muu']
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">Hae lupaa huoneiston muutostöille (AsOYL 4:7).</p>
      </div>
        ...
        <div className="p-8 min-h-[300px] flex flex-col">
          {step === 1 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
              <h2 className="text-xl font-semibold">1. Valitse remontin tyyppi</h2>
          ...
          {step === 2 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
              ...
              <p className="text-sm text-slate-500">Kuvaile remontin laajuus, aikataulu ja käytettävät urakoitsijat.</p>
              <textarea
                value={description}
              ...
              <div className="flex justify-end gap-3 pt-4">
                <button onClick={() => setStep(1)} className="px-4 py-2 text-slate-600 hover:text-slate-900">Takaisin</button>
                <button 
                  onClick={() => setStep(3)} 
          ...
          {step === 3 && (
            <div className="space-y-6 text-center animate-in fade-in slide-in-from-right-4 flex-1 flex flex-col justify-center items-center">
              ...
              <div>
                <h2 className="text-xl font-semibold">Valmista lähetettäväksi?</h2>
                <p className="text-slate-500 mt-2 max-w-md mx-auto">
                  Ilmoituksesi "{category}" lähetetään isännöitsijälle ja hallitukselle käsittelyyn.
                </p>
              </div>
              
              <div className="flex gap-3 pt-4">
                <button onClick={() => setStep(2)} className="px-4 py-2 text-slate-600 hover:text-slate-900">Muokkaa</button>
                <button 
